...
public class LoginPage extends JFrame {
	...
	static JLabel netLabel;
	static JLabel dbLabel;
	static ImageIcon netConnectedImage;
	static ImageIcon netDisconnectedImage;
	static ImageIcon dbConnectedImage;
	static ImageIcon dbDisconnectedImage;
	...
	public static void main(String[] args) throws Exception {
		...
		NetAndDbControllerForLoginPage.start();
		
		NetAndDbControllerForMessagePage.start();
	...
	public LoginPage() {
		...
		usernameLabel.setFont(new Font("Calibri", Font.BOLD, 22));
		usernameLabel.setBounds(50, 96, 108, 51);
		getContentPane().add(usernameLabel);
		
		JLabel passwordLabel = new JLabel("Password: ");
		passwordLabel.setFont(new Font("Calibri", Font.BOLD, 22));
		passwordLabel.setBounds(50, 170, 108, 51);
		getContentPane().add(passwordLabel);
		
		usernameField = new JTextField();
		usernameField.setFont(new Font("Calibri", Font.PLAIN, 22));
		usernameField.setBounds(157, 101, 240, 41);
		...
		passwordField.setBounds(157, 175, 240, 41);
		...
		loginButton.setBounds(127, 312, 108, 41);
		...
		clearButton.setBounds(266, 312, 108, 41);
		...
		showPassCheckbox.setBounds(157, 229, 116, 33);
